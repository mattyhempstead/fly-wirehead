...
The treadmill belt and gait advance with the same presentation clock. The stair scene shows the final five choreography seconds of the climb in one continuous shot, with a low camera pan and no internal cuts or jumps in travel. Earlier travel is omitted before entering the scene, so its eye views are not supplied to the brain. Animation is 1.5× faster, while neural integration and telemetry rates are unchanged. The staircase has 36 risers of 0.17 m, 0.32 m treads, and a 6 m width. The specimen is enlarged in a metre-scale environment. A white cloth wrap follows the anatomical front-right joint from the walking scene onward; it is absent throughout the opening scene, including on replay.
