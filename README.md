...
- **The big reveal:** press **Play reveal** for a 30-second shot: one fly near the centre of the central room → the complete room → a 10 × 10 block of rooms → a 10 × 10 grid of those blocks. Narrow service roads and low borders separate the larger blocks. Neighbouring rooms fade in early and gradually; the outer grid appears instantly at full opacity after the first 100 rooms are visible. The opening restores the saved camera angle and pan, also available through Single station. After the opening hold, the pullback maintains a steady proportional speed through both grid reveals, easing only at the start and finish. Replay it whenever you like; dragging, scrolling, or choosing a view takes over the camera.
