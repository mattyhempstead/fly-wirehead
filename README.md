...
- **96 stations:** aligned metal benches, station IDs, and a regular 8 × 12 layout. A short wire rises from each head into a thin horizontal supply line; the lines meet a horizontal collector at the rear of the room. Each fly's back right leg has a metal cuff and linked chain running over the bench edge to a bolted floor anchor.
- **A containment chamber:** blackened metal, green pools of light, low walls with green trim, drifting floor haze, and subtle surveillance scanlines. Original fly colors and full-color insect footage remain visible against the dark environment.
...
- **The big reveal:** press **Play reveal** for a 30-second shot: one fly near the centre of the central room → the complete room → a 10 × 10 block of rooms → a 10 × 10 grid of those blocks. Narrow service roads and low borders separate the larger blocks. Neighbouring rooms fade in early and gradually. The outer blocks are already present beyond the frame, so the widening camera view reveals them naturally without a visibility switch or fade. The opening restores the saved camera angle and pan, also available through Single station. After the opening hold, the pullback maintains a steady proportional speed through both grid reveals, easing only at the start and finish. Replay it whenever you like; dragging, scrolling, or choosing a view takes over the camera.
