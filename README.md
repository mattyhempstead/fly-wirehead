...
- **The big reveal:** press **Play reveal** for a 30-second shot: one fly → the complete room → a huge 100 × 100 grid of rooms. The first pullback reaches the room at 11 seconds, then keeps going. Replay it whenever you like; dragging, scrolling, or choosing a view takes over the camera.
